...
openai.api_key = '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'
...
class OCRApp(tk.Frame):
    def __init__(self, master=None):
        ...
        self.message_template = tk.StringVar(value="Wähle das Template")  # Default template
    ...
    def create_widgets(self):
        ...
        self.template_dropdown['values'] = ('Suche nach präventiven Maßnahmen', 'Erkläre Fachbegriffe', 'Erzähle mir alles über')
